...
namespace L298Edu {
    ...
    function ensureMode(expected: P1Mode): boolean { return p1Mode == expected }

    // -------- Motorer (BASIS) --------
    //% block="A frem %speed"  //% speed.min=0 speed.max=1023  //% group="Motor"
    export function motorAFrem(speed: number): void {
        pins.digitalWritePin(DigitalPin.P12, 1)
        pins.digitalWritePin(DigitalPin.P13, 0)
        pins.analogWritePin(AnalogPin.P2, speed)
    }
    //% block="A baglæns %speed"  //% speed.min=0 speed.max=1023  //% group="Motor"
    export function motorABaglæns(speed: number): void {
        pins.digitalWritePin(DigitalPin.P12, 0)
        pins.digitalWritePin(DigitalPin.P13, 1)
        pins.analogWritePin(AnalogPin.P2, speed)
    }
    //% block="Stop A"  //% group="Motor"
    export function stopMotorA(): void {
        pins.digitalWritePin(DigitalPin.P12, 0)
        pins.digitalWritePin(DigitalPin.P13, 0)
        pins.analogWritePin(AnalogPin.P2, 0)
    }
    //% block="B frem %speed"  //% speed.min=0 speed.max=1023  //% group="Motor"
    export function motorBFrem(speed: number): void {
        pins.digitalWritePin(DigitalPin.P14, 1)
        pins.digitalWritePin(DigitalPin.P15, 0)
        pins.analogWritePin(AnalogPin.P8, speed)
    }
    //% block="B baglæns %speed"  //% speed.min=0 speed.max=1023  //% group="Motor"
    export function motorBBaglæns(speed: number): void {
        pins.digitalWritePin(DigitalPin.P14, 0)
        pins.digitalWritePin(DigitalPin.P15, 1)
        pins.analogWritePin(AnalogPin.P8, speed)
    }
    //% block="Stop B"  //% group="Motor"
    export function stopMotorB(): void {
        pins.digitalWritePin(DigitalPin.P14, 0)
        pins.digitalWritePin(DigitalPin.P15, 0)
        pins.analogWritePin(AnalogPin.P8, 0)
    }
    //% block="A+B frem %speed"  //% speed.min=0 speed.max=1023  //% group="Motor"
    ...
    //% block="A+B baglæns %speed"  //% speed.min=0 speed.max=1023  //% group="Motor"
     ...
     */
    //% block="Servo P1: %vinkel °"  //% vinkel.min=0 vinkel.max=180
    //% group="P1"  //% advanced=true
     ...
     */
    //% block="WS2812 P1: %n LED"  //% n.min=1 n.max=300
    //% group="P1"  //% advanced=true
     ...
     */
    //% block="Afstand (cm)"  //% group="Sensor"  //% advanced=true
    export function afstandCm(): number {
        ...
        pins.digitalWritePin(DigitalPin(P16), 0) // samme som DigitalPin.P16
